...
import kotlinx.android.synthetic.main.view_one_line_preference.view.*

open class OneLinePreferenceView @JvmOverloads constructor(
        context: Context,
    ...
    init {
        ...
        layoutInflater.inflate(R.layout.view_one_line_preference, this)

        var ta = context.obtainStyledAttributes(attrs, R.styleable.OneLinePreferenceView)
        imageDrawable = ta.getDrawable(R.styleable.OneLinePreferenceView_android_src)
        ta.recycle()

...
public class LogMessage implements Parcelable {
    ...
    public LogMessage(final Priority priority, final String tag, final String message,
    ...
    public boolean equals(final Object o) {
        ...
        if (this == o) {
            ...
            if (mPriority == lm.getPriority() && mMessage.equals(lm.getMessage()) &&
                    mTag.equals(lm.getTag())) {

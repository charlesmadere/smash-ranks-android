...
class AbsTournamentTest : BaseTest() {
    ...
    fun testComparatorChronologicalOrder() {
        val list = listOf(LITE_TOURNAMENT_1, fullTournament, LITE_TOURNAMENT_2, LITE_TOURNAMENT_0)

        Collections.sort(list, AbsTournament.CHRONOLOGICAL_ORDER)
        assertEquals(LITE_TOURNAMENT_0, list[0])
        assertEquals(fullTournament, list[1])
        assertEquals(LITE_TOURNAMENT_1, list[2])
        assertEquals(LITE_TOURNAMENT_2, list[3])
    }
    ...
    fun testComparatorReverseChronologicalOrder() {
        ...
        assertEquals(LITE_TOURNAMENT_2, list[0])
        assertEquals(LITE_TOURNAMENT_1, list[1])
        assertEquals(fullTournament, list[2])
        assertEquals(LITE_TOURNAMENT_0, list[3])
    }

    @Test
    fun testHashCode() {
        assertEquals(fullTournament.id.hashCode(), fullTournament.hashCode())
        assertEquals(LITE_TOURNAMENT_0.id.hashCode(), LITE_TOURNAMENT_0.hashCode())
        assertEquals(LITE_TOURNAMENT_1.id.hashCode(), LITE_TOURNAMENT_1.hashCode())
        assertEquals(LITE_TOURNAMENT_2.id.hashCode(), LITE_TOURNAMENT_2.hashCode())
    }

    @Test
    fun testKind() {
        assertEquals(AbsTournament.Kind.FULL, fullTournament.kind)
        assertEquals(AbsTournament.Kind.LITE, LITE_TOURNAMENT_0.kind)
        assertEquals(AbsTournament.Kind.LITE, LITE_TOURNAMENT_1.kind)
        assertEquals(AbsTournament.Kind.LITE, LITE_TOURNAMENT_2.kind)
    }

...
public class DeepLinkUtilsTest extends BaseTest {
    ...
    public void setUp() throws Exception {
        ...
        mRegionsBundle.getRegions().get(0).setEndpoint(Endpoint.NOT_GAR_PR);
        mRegionsBundle.getRegions().get(1).setEndpoint(Endpoint.NOT_GAR_PR);
        mRegionsBundle.getRegions().get(2).setEndpoint(Endpoint.NOT_GAR_PR);
        mRegionsBundle.getRegions().get(3).setEndpoint(Endpoint.NOT_GAR_PR);
        mRegionsBundle.getRegions().get(4).setEndpoint(Endpoint.GAR_PR);

...
class RankingsNotificationsUtilsTest : BaseTest() {
    ...
    override fun setUp() {
        ...
        rankingsDate1 = gson.fromJson(JSON_RANKINGS_DATE_1, SimpleDate::class.java)
        rankingsDate2 = gson.fromJson(JSON_RANKINGS_DATE_2, SimpleDate::class.java)
        rankingsDate3 = gson.fromJson(JSON_RANKINGS_DATE_3, SimpleDate::class.java)
    }
    ...
    fun testGetNotificationInfo() {
        ...
        rankingsPollingPreferenceStore.rankingsDate.set(rankingsDate1)
        ...
        rankingsPollingPreferenceStore.rankingsDate.set(rankingsDate2)

        pollStatus = rankingsNotificationsUtils.getPollStatus()
        assertEquals(NO_CHANGE, rankingsNotificationsUtils.getNotificationInfo(pollStatus, rankingsBundle))

        rankingsPollingPreferenceStore.rankingsDate.set(rankingsDate3)
    ...
    fun testGetNotificationInfoWithNulls() {
        ...
        assertEquals(CANCEL, rankingsNotificationsUtils.getNotificationInfo(
                PollStatus(rankingsDate1, false, false), null))
    ...
    fun testGetPollStatus() {
        ...
        var pollStatus = rankingsNotificationsUtils.getPollStatus()
        assertNull(pollStatus.oldRankingsDate)
        ...
        pollStatus = rankingsNotificationsUtils.getPollStatus()
        assertNotNull(pollStatus.oldRankingsDate)
        assertEquals(rankingsDate1, pollStatus.oldRankingsDate)
        assertFalse(pollStatus.proceed)

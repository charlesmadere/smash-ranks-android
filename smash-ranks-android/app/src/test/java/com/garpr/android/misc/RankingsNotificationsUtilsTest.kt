...
class RankingsNotificationsUtilsTest : BaseTest() {
    ...
    fun testGetNotificationInfo() {
        assertEquals(RankingsNotificationsUtils.Info.NO_CHANGE, rankingsNotificationsUtils
                .getNotificationInfo(rankingsBundle, RANKINGS_DATE_1, RANKINGS_DATE_2))

        assertEquals(RankingsNotificationsUtils.Info.SHOW, rankingsNotificationsUtils
                .getNotificationInfo(rankingsBundle, RANKINGS_DATE_2, RANKINGS_DATE_1))

        assertEquals(RankingsNotificationsUtils.Info.NO_CHANGE, rankingsNotificationsUtils
                .getNotificationInfo(rankingsBundle, RANKINGS_DATE_1, RANKINGS_DATE_1))

        assertEquals(RankingsNotificationsUtils.Info.NO_CHANGE, rankingsNotificationsUtils
                .getNotificationInfo(rankingsBundle, RANKINGS_DATE_2, RANKINGS_DATE_2))
    }
    ...
    fun testGetNotificationInfoWithNulls() {
        ...
        assertEquals(RankingsNotificationsUtils.Info.CANCEL, rankingsNotificationsUtils
                .getNotificationInfo(null, null, RANKINGS_DATE_1))

        assertEquals(RankingsNotificationsUtils.Info.CANCEL, rankingsNotificationsUtils
                .getNotificationInfo(null, RANKINGS_DATE_2, null))

        assertEquals(RankingsNotificationsUtils.Info.CANCEL, rankingsNotificationsUtils
                .getNotificationInfo(null, RANKINGS_DATE_1, RANKINGS_DATE_2))

        assertEquals(RankingsNotificationsUtils.Info.CANCEL, rankingsNotificationsUtils
                .getNotificationInfo(rankingsBundle, null, null))

        assertEquals(RankingsNotificationsUtils.Info.CANCEL, rankingsNotificationsUtils
                .getNotificationInfo(rankingsBundle, null, RANKINGS_DATE_2))

        assertEquals(RankingsNotificationsUtils.Info.CANCEL, rankingsNotificationsUtils
                .getNotificationInfo(rankingsBundle, RANKINGS_DATE_1, null))
    }
